...
Install, update, preview, or explain mikeploythai's opinionated Claude Code multi-agent setup. It uses Opus 5 at `xhigh` for orchestration and review, Sonnet 5 at `max` for focused workers, and preserves unrelated Claude Code configuration.
