...
Install, update, preview, or explain mikeploythai's opinionated Claude Code multi-agent setup. It uses Fable 5.1 for orchestration and review, Opus 5.5 for frontend work, Sonnet 5 for research and backend work, and preserves unrelated Claude Code configuration.
