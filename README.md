...
Install, update, preview, or explain mikeploythai's opinionated Claude Code multi-agent setup. It uses Opus 5.5 for orchestration, implementation, and review, Sonnet 5 for research, and preserves unrelated Claude Code configuration.
